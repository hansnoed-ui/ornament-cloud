// Erzeugt die Browser-Datendateien des Werks „Das Rad von Zeit und Raum“ maschinell aus den
...
const out = new URL("../portfolio/rad-von-zeit-und-raum/js/data/", import.meta.url);
